-- En primer lugar seleccionaremos la base de datos con la que queremos trabajar. En este caso sakila
USE sakila;
...
SELECT c.customer_id, c.first_name, c.last_name, COUNT(i.film_id) AS total_films
FROM customer c
